...
@FacesValidator(value = "das.tickets.validator.registration.UserEmailLengthValidator")
public class UserEmailLengthValidator implements Validator {
		...
		if (value instanceof String) {
			...
			if (readValue.length() < RegistrationValidationDefinition.VALUE_USER_EMAIL_MIN_LENGTH
				...
				FacesMessage facesMessage = new FacesMessage(
						...
						RegistrationValidationDefinition.MESSAGE_USER_EMAIL_LENGTH,
						null);
